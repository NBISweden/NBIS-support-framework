...
\lhead{\includegraphics[height=1.1cm, width=2.96cm]{logos/nbis_logo.pdf}}
\rhead{\includegraphics[height=1.3cm, width=4cm]{logos/scilifelab_logo.jpg}}
\renewcommand{\headrulewidth}{0pt}
\fancyfoot[C]{\sffamily\fontsize{9pt}{9pt}\selectfont\thepage}

% Project-specific info
\newcommand{\redmineIssue}{\#4582}
\newcommand{\uppmaxProj}{/b2000xxx}
\newcommand{\requesterName}{Re Quester}
\newcommand{\requesterMail}{re.quester@someuni.se}
\newcommand{\piName}{Prin Cipal}
\newcommand{\piMail}{prin.cipal@someuni.se}
\newcommand{\organisation}{Karolinska Institutet}
\newcommand{\refGenome}{\texttt{GRCh38}}

% Staff-specific info
\newcommand{\staffName}{Erik Fasterius}
\newcommand{\staffMail}{erik.fasterius@nbis.se}
\newcommand{\staffWeb}{https://nbis.se/about/staff/erik-fasterius/}

% General NBIS- and support-related info
\newcommand{\affilations}{National Bioinformatics Infrastructure Sweden, %
...
\begin{sffamily}
    ...
    % Title
    \title{\vspace{\fill}\LARGE Vitamin D studies}
    \author{}
    \maketitle
    \thispagestyle{fancy}
...
If you are presenting the results in a paper, at a workshop or at aconference,
...
recommendations}. If applicable, please include \emph{\staffName, \affilations}
